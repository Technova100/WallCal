...
import { ChevronLeft, ChevronRight, Sun, Moon, Trash2, Plus, CheckCircle, Circle, X, Save } from "lucide-react";
...
export default function WallCal() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-[6px] left-1/2 -translate-x-1/2 w-[92%] max-w-[860px] z-50 pointer-events-none">
            ...
            if (i === 11) {
              return (
                <div key={i} className="hanging-clip">
                  <div className="hanging-clip-wire" />
                  <div className="hanging-hole" />
                </div>
              );
            }
            return (
